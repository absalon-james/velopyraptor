...
for i in xrange(50000):
    ...
    f.write("signiferumque. Veri complectitur concludaturque te sed. Ad pri intellegam\n")
    f.write("comprehensam. Detracto pertinax pri ex, usu ne animal mandamus, sit ut\n")
    f.write("delectus forensibus.\n\n")
f.close()
